...
<html lang="en">
    ...
    <body class="market-item animsition">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="list-group">
                                ...
                                <a href="#" class="list-group-item animsition-link clickable">
                            ...
                            <div class="thumbnail">
                                ...
                                <div class="caption-full">
                                    ...
                                    <div class="text-right">
                                        ...
                                        <button id="favButton" class="btn btn-round btn-raised btn-danger btn-fab notLiked">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="form" method="post" action="<?php echo site_url('review') ?>" id="reviewForm">
                            ...
                            <!-- RATING INPUT (HIDDEN) -->
                            <input type="text" style="display:none;" name="rate" id="rating" />
        ...
        <!-- /RATE MODAL -->
        <form id=id-market-name method="post" action="<?php echo site_url('sellerprofile');?>">
            <input type="hidden" name="sellerID" id="idSeller">
        </form>
    </body>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
                ...
                $('#market-price').empty();
                $('#market-price').empty();
                $('#market-price').append($prodData['price'] + " PhP <small> per Kilo </small>");
                $('#market-type').empty();
                $('#market-type').append($prodData['type']);
                $('#market-var').empty();
                $('#market-var').append($prodData['variety']);
                $('#rating-count').empty();
