...
<div class="wrapper">
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>assets/fresh_bootstrap_table/assets/js/bootstrap-table.js"></script>
        ...
        $(document).ready(function() {
            ...
            var $sellerList = <?php echo json_encode($sellerList); ?>;
        ...
        new Chartist.Line('#sellerLine', {
            ...
            series: [
                [$sellerList[0]['regsellercount'], $sellerList[1]['regsellercount'], $sellerList[2]['regsellercount'], $sellerList[3]['regsellercount'], $sellerList[4]['regsellercount'], $sellerList[5]['regsellercount'], $sellerList[6]['regsellercount'], $sellerList[7]['regsellercount'], $sellerList[8]['regsellercount'], $sellerList[9]['regsellercount'], $sellerList[10]['regsellercount'], $sellerList[11]['regsellercount']]
            ]
        });
