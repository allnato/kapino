                                            ...
                                            <div class="tab-pane well" id="Buyerads">
                                                <div class="text-center">
                                                    ...
                                                    <button class="btn btn-raised btn-danger" id="becomeSellerButton"
                                                        ...
                                                        <h4 class="montserrat">Become a Seller</h4>
                                                    </button>
                                                </div>
                                            </div>
                        ...
                        <div class="modal-body-form">
                            <form id= "editForm" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="radio radio-inline">
                                        <label>
                                            <input type="radio" name="typeRadio" value="Arabica">
                                            Arabica
                                        </label>
                                    </div>
                                    <div class="radio radio-inline">
                                        <label>
                                            <input type="radio" name="typeRadio" value="Liberica">
                                            Liberica
                                        </label>
                                    </div>
                                    <div class="radio radio-inline">
                                        <label>
                                            <input type="radio" name="typeRadio" value="Robusta">
                                            Robusta
                                        </label>
                                    </div>
                                    </div>
                                ...
                                <div class="varietyRadios text-center">
                                    ...
                                    <div class="radio radio-inline">
                                        <label>
                                            <input type="radio" name="varRadio" value="Roasted">
                                            Roasted
                                        </label>
                                    </div>
                                    <div class="radio radio-inline">
                                        <label>
                                            <input type="radio" name="varRadio" value="Dried">
                                            Dried
                                        </label>
                                    </div>
                                    <div class="radio radio-inline">
                                        <label>
                                            <input type="radio" name="varRadio" value="Fresh">
                                            Fresh
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group-lg">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 col-md-offset-2">
                                            ...
                                            <div class="form-group has-feedback">
                                                <div class="input-group has-feedback">
                                                        <input id="editAdPrice" type="number" class="form-control text-center" placeholder="Price" required>
                                                        <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                                        <div class="help-block with-errors"></div>
