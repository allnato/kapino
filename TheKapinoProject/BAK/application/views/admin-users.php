							...
							<div class="row numbers">
								...
								<div class="col-md-3">
									<div class="card red">
										<div class="header">
											...
											<p class="category">August 20, 2016</p>
										</div>
										<div class="content">
											<h3 class="montserrat">12 Banned Users</h3>
											<div class="footer">
												<hr />
												<div class="stats">
								...
								<div class="col-md-3">
									<div class="card yellow">
										<div class="header">
											<h4 class="title montserrat">No. of Inactive Users</h4>
											<p class="category">August 20, 2016</p>
										</div>
										<div class="content">
											<h3 class="montserrat">71 Inactive Users</h3>
											<div class="footer">
												<hr />
												<div class="stats">
														<i class="fa fa-history"></i> Updated 3 minutes ago
	...
	<script type="text/javascript">
        ...
        var $userList = <?php echo json_encode($userList); ?>;
				...
				var registeredUser = {
					...
					series: [[14,21,54,11,54,3,20,13,0,0,0,0]]
				};
		...
		$(document).ready(function() {
            ...
            $('#user-seller').empty();
            $('#user-seller').append($activeUsers + " Active Sellers.");
