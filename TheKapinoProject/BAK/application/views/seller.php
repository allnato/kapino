...
<html lang="en">
    ...
    <body class="becomeseller-page">
        <!-- NAVBAR -->
        <nav class="animsition navbar navbar-success navbar-fixed-top" data-animsition-in-class="fade-in-right-sm" data-animsition-out-class="fade-out-left-sm" data-animsition-in-duration="3000" data-animsition-out-duration="2000">
            <div class="container">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <i class="material-icons">account_circle</i> Hi, Joe
                            </a>
                            <ul class="dropdown-menu">
                                <li><a href="<?php echo base_url('profile'); ?>" class="animsition-link">My Profile</a></li>
                                <li class="divider"></li>
                                <li><a href="<?php echo site_url('home'); ?>" class="text-danger animsition-link">Logout</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
